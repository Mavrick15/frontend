...
const EyanoSecurity = () => {
  const TEXT_CONSTANTS = {
    ...
    MAIN_IMAGE_ALT: "Image principale du Centre Diagnostic EYANO",
    SITE_ANALYSIS_IMAGE_ALT: "Image d'analyse du site",
    HD_CAMERA_IMAGE_ALT: "Image d'une caméra HD",
    CONTROL_CENTER_IMAGE_ALT: "Image d'un centre de contrôle",
    ACCESS_CONTROL_IMAGE_ALT: "Image de contrôle d'accès",
  };
    ...
    >
      ...
      >
        ...
        >
          <div className="p-3 bg-gray-100 rounded-xl group-hover:bg-gray-200 transition-colors mr-4">
            <Camera className="h-6 w-6 text-gray-900 flex-shrink-0" />
          </div>
          <div>
            <h4 className="text-lg font-bold mb-2 text-gray-900">{TEXT_CONSTANTS.SOLUTION_CAMERAS_TITLE}</h4>
            <p className="text-gray-700 text-justify leading-relaxed">{TEXT_CONSTANTS.SOLUTION_CAMERAS_DESC}</p>
          </div>
        </motion.div>
        ...
        >
          <div className="p-3 bg-gray-100 rounded-xl group-hover:bg-gray-200 transition-colors mr-4">
            <MapPin className="h-6 w-6 text-gray-900 flex-shrink-0" />
          </div>
          <div>
            <h4 className="text-lg font-bold mb-2 text-gray-900">{TEXT_CONSTANTS.SOLUTION_COVERAGE_TITLE}</h4>
            <p className="text-gray-700 text-justify leading-relaxed">{TEXT_CONSTANTS.SOLUTION_COVERAGE_DESC}</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <h4 className="text-lg font-bold mb-2 text-gray-900">{TEXT_CONSTANTS.SOLUTION_INTEGRATION_TITLE}</h4>
            <p className="text-gray-700 text-justify leading-relaxed">{TEXT_CONSTANTS.SOLUTION_INTEGRATION_DESC}</p>
          </div>
        </motion.div>
        ...
        >
          <div className="p-3 bg-gray-100 rounded-xl group-hover:bg-gray-200 transition-colors mr-4">
            <HardDrive className="h-6 w-6 text-gray-900 flex-shrink-0" />
          </div>
          <div>
            <h4 className="text-lg font-bold mb-2 text-gray-900">{TEXT_CONSTANTS.SOLUTION_RECORDING_TITLE}</h4>
            <p className="text-gray-700 text-justify leading-relaxed">{TEXT_CONSTANTS.SOLUTION_RECORDING_DESC}</p>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <div>
            <h4 className="text-lg font-bold mb-2 text-gray-900">{TEXT_CONSTANTS.TECH_HIKVISION_CAMERAS_TITLE}</h4>
            <p className="text-gray-700 text-justify leading-relaxed">{TEXT_CONSTANTS.TECH_HIKVISION_CAMERAS_DESC}</p>
          </div>
        </motion.div>
        <motion.div 
          variants={listItemVariants} 
        ...
        >
          ...
          <div>
            <h4 className="text-lg font-bold mb-2 text-gray-900">{TEXT_CONSTANTS.TECH_NVR_TITLE}</h4>
            <p className="text-gray-700 text-justify leading-relaxed">{TEXT_CONSTANTS.TECH_NVR_DESC}</p>
          </div>
        </motion.div>
        <motion.div 
          variants={listItemVariants} 
        ...
        >
          <div className="p-3 bg-gray-100 rounded-xl group-hover:bg-gray-200 transition-colors mr-4">
            <Smartphone className="h-6 w-6 text-gray-900 flex-shrink-0" />
          </div>
          <div>
            <h4 className="text-lg font-bold mb-2 text-gray-900">{TEXT_CONSTANTS.TECH_REMOTE_ACCESS_TITLE}</h4>
            <p className="text-gray-700 text-justify leading-relaxed">{TEXT_CONSTANTS.TECH_REMOTE_ACCESS_DESC}</p>
          </div>
        </motion.div>
      </motion.div>
