...
const CONSTANTS = {
  ...
  MESSAGES: {
    ...
    PAGE_TITLE: "Installation Solaire Intelligente",
    INTRO_PARAGRAPH: "Libérez-vous des coupures d'électricité - Systèmes photovoltaïques haute performance avec rendement garanti de 95%. Plus de 500 installations réussies et 2 millions de kWh d'énergie propre produite à Kinshasa.",
    MAIN_IMAGE_ALT: "Panneaux solaires installés sur un toit, produisant de l'énergie propre",
    SOLUTIONS_TITLE: "Nos solutions solaires révolutionnaires",
    SOLUTION_AUDIT_TITLE: "Audit énergétique intelligent et dimensionnement précis",
    SOLUTION_AUDIT_DESC: "Analyse thermographique avancée de votre site - Optimisation garantie de 30% sur votre consommation dès le premier mois.",
    SOLUTION_DESIGN_TITLE: "Conception photovoltaïque haute performance",
    SOLUTION_DESIGN_DESC: "Panneaux monocristallins dernière génération avec rendement 22% - Architecture hybride grid-tie et off-grid pour une autonomie maximale.",
    SOLUTION_INSTALLATION_TITLE: "Installation certifiée avec garantie 25 ans",
    SOLUTION_INSTALLATION_DESC: "Techniciens certifiés IEC 62446 - Installation conforme aux normes internationales avec tests de performance documentés.",
    SOLUTION_STORAGE_TITLE: "Batteries lithium-ion nouvelle génération",
    SOLUTION_STORAGE_DESC: "Autonomie 48h garantie avec batteries LiFePO4 - 6000+ cycles de vie et monitoring intelligent de l'état de charge.",
    SOLUTION_MAINTENANCE_TITLE: "Maintenance prédictive par IoT",
    SOLUTION_MAINTENANCE_DESC_PART1: "Capteurs intelligents avec alertes en temps réel - Intervention préventive avant toute baisse de performance. Complète notre ",
    SOLUTION_MAINTENANCE_DESC_LINK_TEXT: "support technique",
    SOLUTION_MAINTENANCE_DESC_LINK_PATH: "/services/technical-support",
    SOLUTION_MAINTENANCE_DESC_PART2: ".",
    SOLUTION_SMART_HOME_TITLE: "Domotique solaire et gestion intelligente",
    SOLUTION_SMART_HOME_DESC: "Pilotage automatique de votre consommation via application mobile - Économies supplémentaires de 20% grâce à l'optimisation IA.",
    COMMITMENT_TITLE: "Notre engagement : Zéro coupure, 100% autonomie",
    COMMITMENT_PARA1: "Chaque watt compte. Notre équipe d'ingénieurs solaires certifiés conçoit des systèmes sur mesure qui maximisent votre production d'énergie tout en réduisant vos coûts de 60% à 80%. Avec un retour sur investissement moyen de 3 ans, votre installation solaire devient rapidement rentable.",
    COMMITMENT_PARA2: "Nous utilisons exclusivement des équipements Tier 1 (panneaux SunPower, onduleurs SMA/Huawei, batteries BYD) avec une garantie fabricant de 25 ans et notre suivi de performance à vie.",
    TECH_IMAGE_ALT: "Ingénieur examinant les données de production d'un système solaire",
    CARD1_TITLE: "Économies garanties de 60%",
    CARD1_DESCRIPTION: "ROI en 3 ans - Réduisez votre facture d'électricité de 60% à 80% dès la première année.",
    CARD1_IMAGE_ALT: "Maison alimentée par l'énergie solaire, symbolisant l'autonomie",
    CARD2_TITLE: "Fiabilité 25 ans garantie",
    CARD2_DESCRIPTION: "Équipements Tier 1 certifiés - Performance garantie à 85% même après 25 ans d'utilisation.",
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                <motion.div
                  ...
                  className="space-y-6"
                >
                  <h2 className="text-3xl font-bold mb-4 text-gray-900">{CONSTANTS.MESSAGES.SOLUTIONS_TITLE}</h2>
                    ...
                    <li className="flex items-start hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-base mt-1">
                          ...
                          <Link to={CONSTANTS.MESSAGES.SOLUTION_MAINTENANCE_DESC_LINK_PATH} className="text-gray-900 hover:underline font-semibold">
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl border border-gray-200/50 shadow-sm hover:shadow-md transition-shadow">
                    <h2 className="text-3xl font-bold mb-4 text-gray-900">{CONSTANTS.MESSAGES.COMMITMENT_TITLE}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                >
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-lg font-medium text-gray-900">{CONSTANTS.MESSAGES.CARD1_TITLE}</h3>
                ...
                >
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-lg font-medium text-gray-900">{CONSTANTS.MESSAGES.CARD2_TITLE}</h3>
                ...
                >
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-lg font-medium text-gray-900">{CONSTANTS.MESSAGES.CARD3_TITLE}</h3>
