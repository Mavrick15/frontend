...
const CONSTANTS = {
  ...
  MESSAGES: {
    ...
    HEADER_TITLE: "Ingénierie Réseau de Nouvelle Génération",
    HEADER_DESCRIPTION: "Concevons des réseaux sur mesure avec des performances exceptionnelles - Vitesse 10Gb, sécurité militaire et disponibilité 99.9%. Plus de 200 infrastructures déployées avec succès à Kinshasa.",
    MAIN_IMAGE_ALT: "Infrastructure réseau haute performance installée par Zetoun Labs",
    SOLUTIONS_TITLE: "Nos solutions réseau révolutionnaires",
    SOLUTION_LAN_WAN_TITLE: "Architectures LAN/WAN ultra-rapides",
    SOLUTION_LAN_WAN_DESC: "Débit jusqu'à 10Gb/s avec latence <1ms - Scalabilité infinie pour votre croissance exponentielle.",
    SOLUTION_CABLING_TITLE: "Câblage structuré de précision",
    SOLUTION_CABLING_DESC: "Fibre optique monomode, cuivre Cat8 - Certifications TIA-568 et garantie performance 25 ans.",
