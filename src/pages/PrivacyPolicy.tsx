...
import { ArrowLeft, Shield, FileText, Lock, Eye, Mail, Sparkles } from 'lucide-react';
  ...
  return (
    <PageLayout>
      ...
      <motion.section
        ...
        animate="animate"
        exit="exit"
        className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-gray-50 to-gray-100"
      >
        <motion.div
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Link
                ...
                className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-6 transition-all duration-300 font-semibold group"
              >
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-3 mb-4">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold drop-shadow-lg">{TEXT_CONSTANTS.PRIVACY_MESSAGES.PAGE_TITLE}</h1>
                </div>
                <p className="text-gray-200 text-sm md:text-base">{TEXT_CONSTANTS.PRIVACY_MESSAGES.LAST_UPDATED} {TEXT_CONSTANTS.LAST_UPDATED_DATE}</p>
              </div>
            </motion.div>
            ...
            <div className="space-y-6">
              <Card className="bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-xl rounded-2xl overflow-hidden">
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      <FileText className="h-6 w-6 text-gray-700" />
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.INTRO_HEADING}
                    </h2>
                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      ...
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_COLLECTION_HEADING}
                    </h2>
                    ...
                    <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_COLLECTION_LIST_ITEM_1}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_COLLECTION_LIST_ITEM_2}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_COLLECTION_LIST_ITEM_3}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_COLLECTION_LIST_ITEM_4}</li>
                    </ul>
                    <p className="text-gray-700 leading-relaxed text-base md:text-lg">
                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      ...
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_HEADING}
                    </h2>
                    <p className="text-gray-700 mb-4 leading-relaxed text-base md:text-lg">
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_PARA}
                    </p>
                    <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_LIST_ITEM_1}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_LIST_ITEM_2}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_LIST_ITEM_3}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_LIST_ITEM_4}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_LIST_ITEM_5}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_LIST_ITEM_6}</li>
                      <li className="leading-relaxed">{TEXT_CONSTANTS.PRIVACY_MESSAGES.INFO_USAGE_LIST_ITEM_7}</li>
                    </ul>
                  </motion.div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-xl rounded-2xl overflow-hidden">
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      <FileText className="h-6 w-6 text-gray-700" />
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.COOKIES_HEADING}
                    </h2>
                    <p className="text-gray-700 leading-relaxed text-base md:text-lg">
              ...
              <Card className="bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-xl rounded-2xl overflow-hidden">
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      <Sparkles className="h-6 w-6 text-gray-700" />
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.THIRD_PARTY_HEADING}
                    </h2>
                    <p className="text-gray-700 leading-relaxed text-base md:text-lg">
              ...
              <Card className="bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-xl rounded-2xl overflow-hidden">
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      <FileText className="h-6 w-6 text-gray-700" />
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.DATA_RETENTION_HEADING}
                    </h2>
                    <p className="text-gray-700 leading-relaxed text-base md:text-lg">
                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      ...
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.SECURITY_HEADING}
                    </h2>
                    <p className="text-gray-700 leading-relaxed text-base md:text-lg">
                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      ...
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.YOUR_RIGHTS_HEADING}
                    </h2>
                    <p className="text-gray-700 leading-relaxed text-base md:text-lg">
              ...
              <Card className="bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-xl rounded-2xl overflow-hidden">
                <CardContent className="p-6 md:p-8">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 flex items-center gap-3">
                      <FileText className="h-6 w-6 text-gray-700" />
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.CHANGES_HEADING}
                    </h2>
                    <p className="text-gray-700 leading-relaxed text-base md:text-lg">
              ...
              <Card className="bg-gradient-to-br from-gray-900 via-gray-800 to-black border border-gray-700/50 shadow-2xl rounded-2xl overflow-hidden relative">
                <div className="absolute inset-0 opacity-20" style={{
                  backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.05'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
                }}></div>
                <CardContent className="p-6 md:p-8 relative z-10">
                  ...
                  >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white flex items-center gap-3">
                      ...
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.CONTACT_HEADING}
                    </h2>
                    <p className="text-gray-200 leading-relaxed text-base md:text-lg">
                      {TEXT_CONSTANTS.PRIVACY_MESSAGES.CONTACT_PARA} 
                      <a 
                        href={`mailto:${TEXT_CONSTANTS.CONTACT_EMAIL}`} 
                        className="text-white font-bold hover:text-gray-300 underline transition-colors ml-1"
                      >
                        {TEXT_CONSTANTS.CONTACT_EMAIL}
                      </a>
                    </p>
                  </motion.div>
                </CardContent>
