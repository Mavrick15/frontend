...
const PoliceJudiciaire = lazy(
  () => import("./pages/realisations/PoliceJudiciaire"),
);
const EyanoSecurity = lazy(() => import("./pages/realisations/EyanoSecurity"));
const CreditShopAfrica = lazy(
  () => import("./pages/realisations/CreditShopAfrica"),
);
const DevelopmentProcess = lazy(
  () => import("./pages/realisations/DevelopmentProcess"),
);
const About = lazy(() => import("./pages/About"));
const PrivacyPolicy = lazy(() => import("./pages/PrivacyPolicy"));
const Blog = lazy(() => import("./pages/Blog"));
const BlogPostDetail = lazy(() => import("./pages/BlogPostDetail"));
const NetworkEngineering = lazy(
  () => import("./pages/services/NetworkEngineering"),
);
const VideoSurveillance = lazy(
  () => import("./pages/services/VideoSurveillance"),
);
const WebDevelopment = lazy(() => import("./pages/services/WebDevelopment"));
const ITManagement = lazy(() => import("./pages/services/ITManagement"));
const TechnicalSupport = lazy(
  () => import("./pages/services/TechnicalSupport"),
);
const SolarInstallation = lazy(
  () => import("./pages/services/SolarInstallation"),
);
const LinuxAdministration = lazy(
  () => import("./pages/formations/LinuxAdministration"),
);
const NetworkAdministration = lazy(
  () => import("./pages/formations/NetworkAdministration"),
);
const ComputerMaintenance = lazy(
  () => import("./pages/formations/ComputerMaintenance"),
);
const WindowsAdministration = lazy(
  () => import("./pages/formations/WindowsAdministration"),
);
const VirtualizationTraining = lazy(
  () => import("./pages/formations/VirtualizationTraining"),
);
      ...
      return (
        <div className="flex items-center justify-center min-h-screen bg-red-50 text-red-700 p-4 rounded-lg shadow-md">
          <div className="text-center">
            ...
            <p className="mb-2">{APP_MESSAGES.ERROR_BOUNDARY_P1}</p>
