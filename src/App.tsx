...
const ZetoulogPage = lazy(() => import("./components/ZetoulogPage"));
...
const App = () => {
  ...
  React.useEffect(() => {
    ...
    const interval = setInterval(() => {
      currentProgress += APP_MESSAGES.LOADING_PROGRESS_STEP;
      if (currentProgress <= APP_MESSAGES.MAX_LOADING_PROGRESS) {
        setLoadingProgress(currentProgress);
      } else {
        setLoadingProgress(APP_MESSAGES.MAX_LOADING_PROGRESS);
        clearInterval(interval);
        setTimeout(() => {
          setLoadingProgress(100);
          setIsAppReady(true);
        }, APP_MESSAGES.FINAL_LOADING_DELAY_MS);
      }
  ...
  const FullPageLoader = () => (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 text-white">
      <div className="relative w-28 h-28">
        ...
        <div className="absolute inset-0 rounded-full border-4 border-t-gray-400 border-b-gray-400 border-l-gray-300 border-r-gray-300 animate-spin"></div>
        <div
        ...
        ></div>
        <div className="absolute inset-0 flex items-center justify-center text-gray-100 text-2xl font-bold">
          {loadingProgress}%
        </div>
      </div>
    </div>
            ...
            <Suspense fallback={<FullPageLoader />}>
              {isAppReady ? (
                <Routes>
                  ...
                  <Route path="/zetoulog" element={<ZetoulogPage />} />
