...
const BlogPreview = () => {
  ...
  return (
    <section id="blog" className="py-12 md:py-24 px-4 md:px-12 bg-gradient-to-br from-white via-gray-50 to-gray-100">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12">
          ...
          <Link to="/blog" className="mt-4 md:mt-0">
            <Button variant="outline" className="group border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white shadow-lg hover:shadow-xl transition-all duration-300 px-6 py-6 rounded-xl font-semibold">
