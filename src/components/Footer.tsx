...
const TEXT_CONSTANTS = {
  ...
  COPYRIGHT_TEXT: (year: number) =>
    `© ${year} Zetoun Labs inc. Tous droits réservés.`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
              ...
              <div className="h-12 w-12 mr-2">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.alt =
                      TEXT_CONSTANTS.LOGO_PLACEHOLDER_ALT_TEXT;
                  }}
                />
              </div>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">
              {TEXT_CONSTANTS.COMPANY_LINKS_HEADING}
            </h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">
              {TEXT_CONSTANTS.CONTACT_US_HEADING}
            </h3>
            <div className="space-y-4">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <a
                  href={`mailto:${TEXT_CONSTANTS.EMAIL_ADDRESS}`}
              ...
              <div className="flex items-center text-gray-300">
                ...
                <a
                  href={`tel:${TEXT_CONSTANTS.PHONE_NUMBER.replace(/\s/g, "")}`}
                  className="hover:text-white transition-colors"
                >
